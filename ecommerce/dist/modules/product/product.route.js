...
router.put("/:id/approve", authenticateToken, requireManager, controller.approveProduct.bind(controller));
router.put("/:id/reject", authenticateToken, requireManager, controller.rejectProduct.bind(controller));
router.put("/:id/vip", authenticateToken, requireManager, controller.setVipStatus.bind(controller));
